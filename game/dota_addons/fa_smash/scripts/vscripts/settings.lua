...
CUSTOM_RUNE_SPAWN_TIME = 60

GOLD_PER_TICK = 1                     	-- How much gold should players get per tick?
GOLD_TICK_TIME = 0.2                    -- How long should we wait in seconds between gold ticks?
...
XP_PER_LEVEL_TABLE = {
-- 0,200,500,800,1250,1950,2750,3550,4450,5450,6450,7450,8450,9450,10450,11450,12450,13850,14850,15950,16950,17950,18950,19950,21000
0,200,500,800,1250,1950,2750,3550,4450,5450,6450,7450,8450,9450,10450,11450,12450,13850,14850,15950,16950,17950,18950,19950,21000
}
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 231, 33, 224 }  --    BLUE
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 212, 50, 52 }   --    RED
TEAM_COLORS[DOTA_TEAM_CUSTOM_1] = { 230, 238, 2 }  --    JAUNE
TEAM_COLORS[DOTA_TEAM_CUSTOM_2] = { 255, 108, 0 }   --    Orange
TEAM_COLORS[DOTA_TEAM_CUSTOM_3] = { 52, 85, 255 }   --    Blue
TEAM_COLORS[DOTA_TEAM_CUSTOM_4] = { 138, 255, 0 }  --    Green
TEAM_COLORS[DOTA_TEAM_CUSTOM_5] = { 129, 83, 54 }   --    Brown
TEAM_COLORS[DOTA_TEAM_CUSTOM_6] = { 146, 35, 210 }  --    Cyan
