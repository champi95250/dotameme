...
function Lift(keys)
	...
	caster:AddAbility("catmancer_miaou_land")
	caster:SwapAbilities("catmancer_pelote", "catmancer_miaou_land", false, true)
	caster:FindAbilityByName("catmancer_miaou_land"):UpgradeAbility(true)
end
...
function Drop(keys)
	...
	local telekinesis = caster:FindAbilityByName("catmancer_pelote")
	-- Chosen drop point
...
function Impact(keys)
	...
	caster:SwapAbilities("catmancer_miaou_land", "catmancer_pelote", false, true)
	caster:RemoveAbility("catmancer_miaou_land")
