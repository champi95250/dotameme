modifier_spike_bomb_thinker_lua = class({})

--------------------------------------------------------------------------------

function modifier_spike_bomb_thinker_lua:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_spike_bomb_thinker_lua:OnCreated( kv )
	...
	if IsServer() then
		self:StartIntervalThink( self.light_strike_array_delay_time ) -- 7.0
...
function modifier_spike_bomb_thinker_lua:OnIntervalThink()
	if IsServer() then
