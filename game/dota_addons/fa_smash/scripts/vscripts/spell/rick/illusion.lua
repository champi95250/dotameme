function Phantasm( keys )
	...
	local extra_illusion_chance = RandomInt(1, ability_level+1)
	print(ability_level)
	...
	if extra_illusion_chance == 1 then
		images_count = 1
		print("1 illusion")
	elseif extra_illusion_chance == 2 then
		images_count = 3
		print("3 illusion")
	elseif extra_illusion_chance == 3 then
		images_count = 7
		print("7 illusion")
	elseif extra_illusion_chance == 4 then
		images_count = 11
		print("11 illusion")
	end
